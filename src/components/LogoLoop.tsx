import { useCallback, useEffect, useMemo, useRef, useState, memo, CSSProperties, RefObject } from 'react';
import './LogoLoop.css';
...
const useAnimationLoop = (
  ...
  useEffect(() => {
    ...
    const animate = (timestamp: number) => {
      // Skip computation when off-screen but keep RAF alive
...
export const LogoLoop = memo<LogoLoopProps>(
  ({
    ...
    useAnimationLoop(containerRef, trackRef, targetVelocity, seqWidth, isHovered, pauseOnHover);
