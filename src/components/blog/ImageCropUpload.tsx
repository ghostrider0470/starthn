            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col gap-1.5">
                <button
                  ...
                  className="rounded-md bg-background px-3 py-1.5 text-xs font-medium shadow-sm border hover:bg-accent transition-colors"
                >
                  {t('admin.imageCrop.replace')}
                </button>
                <button
                  onClick={() => onChange(null)}
                  className="rounded-md bg-background px-3 py-1.5 text-xs font-medium shadow-sm border hover:bg-destructive/10 hover:text-destructive transition-colors"
                >
                  {t('admin.imageCrop.remove', 'Remove')}
                </button>
              </div>
            </div>
          ) : (
