  ...
  return (
    <div className="relative">
      ...
      <AnimatePresence>
        {phase === 'scanline' && (
          <motion.div
            className="absolute inset-x-0 h-1 bg-gradient-to-r from-transparent via-primary to-transparent z-50 pointer-events-none hidden dark:block"
            style={{ boxShadow: '0 0 20px 10px rgba(255,107,53,0.5)' }}
            initial={{ top: 0, opacity: 1 }}
            animate={{ top: '100%', opacity: [1, 1, 0.8] }}
            exit={{ opacity: 0 }}
