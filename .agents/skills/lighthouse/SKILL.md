...
```bash
node .Codex/skills/lighthouse/scripts/audit.js <url> [--desktop] [--mobile]
```
...
```bash
node .Codex/skills/lighthouse/scripts/audit.js https://example.com/page1 https://example.com/page2
```

### From Sitemap

```bash
node .Codex/skills/lighthouse/scripts/audit.js --sitemap https://example.com/sitemap.xml
```

### Specific Categories

```bash
node .Codex/skills/lighthouse/scripts/audit.js <url> --categories=perf,a11y,bp,seo
```
