...
public interface IBlogService
{
    ...
    Task<Dictionary<string, BlogPostTranslation>?> TranslateAsync(string slug, List<string> languages, ITranslationService translationService);
    Task<BlogPostTranslation?> UpdateTranslationAsync(string slug, string lang, UpdateTranslationRequest request);
    Task<Dictionary<string, BlogPostTranslation>?> GetTranslationsAsync(string slug);
